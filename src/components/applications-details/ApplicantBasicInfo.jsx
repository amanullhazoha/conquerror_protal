  ...
  return (
    <div className="border-[1px] border-[#E5E5E5] p-[24px] rounded-[16px]">
      <div className="flex items-center justify-between mb-[24px]">
        ...
        <button className="border-[1px] border-gray-200 text-gray-900 p-[8px_12px] rounded-[32px] font-medium text-[12px]">Edit</button>
      </div>
      ...
      <div className="mb-5 border-b border-gray-50 pb-3">
        <FormInput label="Nationality" placeholder="First Name" value="Nepal" />
      </div>
      <div className="mb-5 border-b border-gray-50 pb-3">
